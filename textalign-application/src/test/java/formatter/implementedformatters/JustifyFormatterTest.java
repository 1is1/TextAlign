...
public class JustifyFormatterTest {
	...
	@Before
	public void setUp() {
		_formatter = JustifyFormatter.INSTANCE;
		_outputWidth = 10;
	}
	...
	public void formatStringTest_multiLineString_formattedString() {
		// Arrange
		String inputString = "hey you there partner of mine";
		int outputWidth = 20;
		
		// Act
		String actual = _formatter.formatString(inputString, outputWidth);
		
		// Assert
		String expected =
				"hey     you    there" + System.lineSeparator() +
				"partner    of   mine" ;
		assertEquals(expected, actual);
	}
